...
import com.tang.project.dto.CipherData;
import com.tang.project.dto.CipherResult;
import com.tang.project.mapper.CipherMapper;
...
//        cipherMapper.insert(cipherData);
        //返回本地加密ID
...
//                cipherRepository.findById(cipherId).orElseThrow(() -> new IllegalArgumentException("invlaid cipherId"));
        //加载密钥
