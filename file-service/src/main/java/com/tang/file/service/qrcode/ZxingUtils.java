...
//        return pathname;
    ...
    public static void main(String[] args) {
        ...
        //背景图片地址 todo
        String backgroundPath = "D:\\image\\timg.jpg";
        ...
        try {
            ...
            String text = "这是图片上的文字XXXXXXXXX";
//            image = ZxingUtils.drawString(image, text, 375, 647,font,new Color(244,254,189));
            image = ZxingUtils.drawString(image, text, 375, 647,font,new Color(0x000000));
            //图片转inputStream
        ...
        //保存的图片路径
        String originalFileName = "D:\\image\\11111.jpg";
        try {
            //保存为本地图片
